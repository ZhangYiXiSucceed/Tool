...
#include "../UltrasonicDetectionSystem/Database.h"
...
QT_MOC_LITERAL(3, 18, 26) // "DisplayFrequencyDomainLast"

    },
    "Database\0Display\0\0DisplayFrequencyDomainLast"
};
...
void Database::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->DisplayFrequencyDomainLast(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Database::Display)) {
                *result = 0;
                return;
            }
        }
